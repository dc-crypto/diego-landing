    ...
    <>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .wa-fab {
          ...
          transition: opacity 0.35s ease, transform 0.25s cubic-bezier(0.23,1,0.32,1),
      ...
      <div className="ce-page">
        ...
        <a
          ...
          aria-hidden={!showWA}
          style={{ opacity: showWA ? 1 : 0, pointerEvents: showWA ? "auto" : "none" }}
        >
